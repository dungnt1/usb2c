...
class Illusion_AjaxLayeredNavigation_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price {
    ...
    public function __construct() {
        ...
        if(Mage::getStoreConfig('illusion_ajaxlayerednavigation/config/enabled')){
           $this->setTemplate('ajaxlayerednavigation/filter.phtml');
        }
    }

    /**
     * Return max range price
     * @return mixed
     */
