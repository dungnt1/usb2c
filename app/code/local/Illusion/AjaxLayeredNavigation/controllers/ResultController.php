...
class Illusion_AjaxLayeredNavigation_ResultController extends Mage_CatalogSearch_ResultController {
    ...
    public function indexAction() {
        ...
        if (Mage::helper('illusion_ajaxlayerednavigation/data')->isAjax() && $layer_action == 1) {
            ...
            if ($query->getQueryText() != '') {
                ...
                $data['removeItem'] = Mage::helper('illusion_ajaxlayerednavigation/data')->getJsRemoveItem();
