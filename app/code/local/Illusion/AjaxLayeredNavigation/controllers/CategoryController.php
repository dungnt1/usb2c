...
class Illusion_AjaxLayeredNavigation_CategoryController extends Mage_Catalog_CategoryController {
    ...
    public function viewAction() {
        ...
        if (Mage::helper('illusion_ajaxlayerednavigation')->isAjax() && $layer_action == 1) {
            $data = array();
