...
class Illusion_AjaxLayeredNavigation_ProductController extends Mage_Tag_ProductController {

    public function listAction() {

        $layer_action = $this->getRequest()->getParam('layer_action');

        if (Mage::helper('illusion_ajaxlayerednavigation/data')->isAjax() && $layer_action == 1) {
            $data = array();
            ...
            $data['tagtoolbarjs'] = Mage::helper('illusion_ajaxlayerednavigation/data')->getToolbarForTagProductJs();
