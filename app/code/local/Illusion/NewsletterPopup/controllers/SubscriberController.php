...
class Illusion_NewsletterPopup_SubscriberController extends Mage_Newsletter_SubscriberController {

    public function newAction(){

        parent::newAction();

        if (!Mage::getStoreConfig('newsletterpopup/common/isactive'))
            return '';
