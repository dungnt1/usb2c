<?php
class Illusion_Settings_Block_Adminhtml_System_Config_Form_Fields_Color extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Add color picker
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $jsPath = $this->getJsUrl('illusion/jquery-1.7.2.min.js');
        $mcPath = $this->getJsUrl('illusion/plugins/mcolorpicker/');
