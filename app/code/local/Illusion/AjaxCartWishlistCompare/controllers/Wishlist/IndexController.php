...
class Illusion_AjaxCartWishlistCompare_Wishlist_IndexController extends Mage_Wishlist_IndexController {

    /**
     * overwrite Adding new item
     */
    public function addAction(){
        header("Content-type: application/json");
        Mage::log('doso dovde 1', null, 'doso.log', true);

        if ($this->getRequest()->getParam('callback')) {
            Mage::log('doso dovde 2', null, 'doso.log', true);
