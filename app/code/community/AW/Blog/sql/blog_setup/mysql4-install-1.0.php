...
try {
    $installer->run("
        ...
        INSERT INTO {$this->getTable('blog/blog')} (`post_id` ,`cat_id`, `title` ,`post_content` ,`status` ,`created_time` ,`update_time` ,`image`, `identifier` ,`user` ,`update_user` ,`meta_keywords` ,`meta_description`)
        VALUES (NULL ,'0', 'Hello World', 'Welcome to Magento Blog. This is your first post. Edit or delete it, then start blogging!', '1', '2010-09-06 07:28:34' , NOW( ) , 'blog_img.jpg', 'Hello', 'Joe Blogs', 'Joe Blogs', 'Keywords', 'Description');
