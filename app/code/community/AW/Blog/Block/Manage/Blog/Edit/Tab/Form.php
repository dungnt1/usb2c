...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('imager', 'file', array(
            'label'     => Mage::helper('blog')->__('Image'),
            'required'  => false,
            'name'      => 'image',
        ));

        $fieldset->addType('locationimage','AW_Blog_Block_Manage_Blog_Edit_Form_Element_Image');
        $fieldset->addField('image', 'locationimage', array(
            'label'     => Mage::helper('blog')->__('Image'),
            'name'      => 'image',
            'required'  => false,
        ));
