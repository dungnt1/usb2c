...
class Inchoo_SocialConnect_Block_Header extends Mage_Core_Block_Template{
    ...
    protected function _construct() {
        ...
        Mage::register('inchoo_socialconnect_button_text', $this->__(' '));

        $this->setTemplate('inchoo/socialconnect/header.phtml');
    }
